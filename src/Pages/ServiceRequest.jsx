...
export default function ServiceRequest() {
  ...
  const requiredLeft = useMemo(() => {
    return ["customer_name", "contact", "attachment_type", "attachment_model", "attachment_serial", "symptom"]
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="grid gap-6 mt-6">
            ...
            <Section title={t("attachments_title") || "Attachments">
              <div className="text-xs text-slate-500 mb-3">{t("per_file_limit") || "Per-file size limit"}: 15MB</div>
              <input
                type="file"
